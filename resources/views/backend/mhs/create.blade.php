<x-main-layout>
    @section('title', 'Tambah Mahasiswa - {{ $department->nama }}')
    <div class="nk-block-head">
        <div class="nk-block-head-content">
            <h4 class="title nk-block-title">Tambah Data Mahasiswa</h4>
            <div class="nk-block-des">
                <p><a href="{{ route('admin.mhs.by.department', $department->id) }}">Back</a></p>
            </div>
        </div>
    </div>
    ...
    <div class="card card-bordered card-preview">
        <div class="card-inner">
            <div class="preview-block">
                <span class="preview-title-lg overline-title">Form Tambah Data Mahasiswa</span>
                <form method="POST" action="{{ route('admin.mhs.store', $department->id) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" name="nama_mhs"
                                        value="{{ old('nama_mhs') }}" placeholder="Nama Mahasiswa">
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    ...
                                    <input type="text" class="form-control" value="{{ $department->nama }}" disabled>
                                </div>
