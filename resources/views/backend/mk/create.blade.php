<x-main-layout>
    @section('title', 'Tambah Mata Kuliah - {{ $department->nama }}')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form class="form-horizontal" method="POST" action="{{ route('admin.mk.store', $department->id) }}">
                    @csrf
                    <div class="card-body">
                        <h4 class="card-title">Tambah Mata Kuliah - {{ $department->nama }}</h4>

                        <!-- Nama Mata Kuliah -->
                        <div class="form-group row">
                            <label for="name" class="col-sm-3 text-end control-label col-form-label">Nama Mata
                                Kuliah</label>
                            <div class="col-sm-9">
