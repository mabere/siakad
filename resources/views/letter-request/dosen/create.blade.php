                        ...
                        <div class="nk-block-between">
                            ...
                            <div class="nk-block-head-content">
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    <a href="{{ route('lecturer.request.surat.index') }}"
                    ...
                    <div class="nk-block">
                        <div class="card">
                            <div class="card-inner">
                                <form action="{{ route('lecturer.request.surat.store') }}" method="POST"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <select
                                                        class="form-select @error('letter_type_id') is-invalid @enderror"
                                                        id="letter_type_id" name="letter_type_id" required>
                                                        <option value="">Pilih Jenis Surat</option>
                                                        @foreach($letterType as $type)
                                                        <option value="{{ $type->id }}" {{
                                                            old('letter_type_id')==$type->
                                                            id ? 'selected' : '' }}
        ...
        (function($) {
            ...
            $(document).ready(function() {
                ...
                $('#letter-form').on('submit', function(e) {
                    ...
                    const selectedType = $('#letter_type_id').val();
                    if (!selectedType) {
                            ...
                            if (response.success) {
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        window.location.href = response.redirect || "{{ route('lecturer.request.surat.index') }}";
                                    }
                                });
                            } else {
