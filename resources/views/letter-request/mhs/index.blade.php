<x-main-layout>
                        ...
                        <div class="nk-block-between">
                            ...
                            <div class="nk-block-head-content">
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    <a href="{{ route('student.request.surat.create') }}" class="btn btn-primary">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <ul class="link-list-opt">
                                                            <li>
                                                                <a
                                                                    href="{{ route('student.request.surat.show', $request) }}">
                                                            ...
                                                            <li>
                                                                <a
                                                                    href="{{ route('student.request.surat.edit', $request) }}">
                                                            ...
                                                            <li>
                                                                ...
                                                                <form id="delete-form-{{ $request->id }}"
                                                                    action="{{ route('student.request.surat.destroy', $request) }}"
                                                            ...
                                                            <li>
                                                                <a
                                                                    href="{{ route('student.request.surat.download', $request) }}">
    ...
    <script>
        ...
        e.preventDefault();
        const url = $(this).data('url'); // Misalnya: route('student.request.surat.destroy', $letterRequest)
