    ...
    <div class="container py-4">
        <div class="card shadow-sm border-0 rounded-lg">
            ...
            <div class="card-body">
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            <th>Tujuan Surat</th>
                            <td>{{ $letterRequest->letterType->faculty->nama }}</td>
                        </tr>
                        <tr>
                            <th>Otoritas</th>
                            <td>{{ $letterRequest->letterType->faculty->dekan }}</td>
                        </tr>
                        <tr>
                            <th>Status</th>
                            <td>
                ...
                <div id="approveFormContainer" class="mt-3 d-none">
                    <form action="{{ route('dekan.surat-masuk.update', $letterRequest->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                        ...
                        <a href="{{ route('dekan.surat-masuk.index') }}" class="btn btn-secondary">Kembali</a>
                    </form>
                </div>

                <div id="rejectFormContainer" class="mt-3 d-none">
                    <form action="{{ route('dekan.surat-masuk.reject', $letterRequest->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                ...
                <div class="mt-4">
                    <div class="card bg-light">
                        <div class="card-body">
                            ...
                            <a href="{{ route('dekan.surat-masuk.download', $letterRequest) }}" class="btn btn-primary">
            ...
            <div class="card-footer">
                <a class="btn btn-warning btn-md" href="{{ route('dekan.surat-masuk.index') }}">Kembali</a>
            </div>
        </div>
    </div>
</x-main-layout>