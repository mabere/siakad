<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Name -->
        <div>
            <x-custom.input-label for="name" :value="__('Name')" />
            <x-custom.text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')"
        ...
        <div class="mt-4">
            ...
            <x-custom.text-input id="password" class="block mt-1 w-full" type="password" name="password" required
        ...
        <div class="mt-4">
            ...
            <x-custom.text-input id="password_confirmation" class="block mt-1 w-full" type="password"
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-custom.primary-button class="ms-4">
                {{ __('Register') }}
