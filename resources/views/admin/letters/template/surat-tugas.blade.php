...
<head>
    <meta charset="utf-8">
    <title>SURAT PENUGASAN DOSEN</title>
    <style>
        table {
            width: 100%;
...
<body>
    ...
    $department = $letterRequest->user->lecturer->department;
    ...
    <div style="text-align: center; margin-bottom: 20px;">
        <p><u><strong>SURAT PENUGASAN DOSEN</strong></u><br>
    ...
    <div class="content" style="margin: 0 3rem 4rem 3rem">
        <p style="text-align: justify;space-between:10px">Dekan Fakultas {{
            $letterRequest->user->lecturer->department->faculty->nama }}, Universitas Lakidende Unaaha, dengan ini
            menugaskan kepada saudara:</p>
        ...
        <p style="text-align: justify;space-between:10px">untuk mengikuti kegiatan {{ $form_data['Tujuan'] }}, pada
            {{ $form_data['Waktu'] }} 12 Juli 2025.</p>
    </div>
