...
<body>
    ...
    <div style="text-align: center; margin-bottom: 20px;">
        <p><u><strong>SURAT KETERANGAN AKTIF KULIAH</strong></u><br>
    ...
    <div class="content" style="margin: 0 3rem 4rem 3rem">
        <p style="text-align: justify;space-between:10px">Dekan Fakultas {{
            $letterRequest->user->student->department->faculty->nama }}, Universitas Lakidende Unaaha, dengan ini
            menerangkan bahwa:</p>
        ...
        <p style="text-align: justify;space-between:10px">Benar tercatat sebagai mahasiswa Fakultas {{
            $letterRequest->user->student->department->faculty->nama }},
            Universitas Lakidende Unaaha, yang terdaftar pada Tahun Akademik {{ $academic_year }}.</p>
        <p style="text-align: justify;space-between:10px">Demikian surat keterangan ini dikeluarkan dengan sebenarnya
            untuk keperluan {{ $form_data['Peruntukan'] }}.</p>
    </div>
