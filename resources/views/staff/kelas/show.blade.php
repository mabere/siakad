            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        <div class="card-header">
                            <div class="ms-auto">
                                <a href="{{ route('staff.kelas.index') }}" class="btn btn-success pull-left">
                                    <i class="fa fa-arrow-left"></i> Back </a>
                                <a type="submit" href="{{ route('staff.kelas.add-students', $idKelas) }}"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form action="{{ route('staff.kelas.remove-student', [$idKelas, $items->id]) }}"
