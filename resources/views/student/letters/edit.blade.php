<!-- filepath: /c:/Users/ramli/Herd/lb/resources/views/student/letters/edit.blade.php -->
<x-main-layout>
    <div class="container">
        ...
        <form action="{{ route('student.request.surat.update', $letterRequest->id) }}" method="POST" id="letter-form">
            ...
            <div class="form-group">
                <label for="tipe_surat_id">Jenis Permohonan Surat</label>
                <input type="text" class="form-control" value="{{ $letterRequest->letterType->name }}" disabled>
                <input type="hidden" name="tipe_surat_id" value="{{ $letterRequest->tipe_surat_id }}">
            </div>
